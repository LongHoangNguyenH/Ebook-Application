		...
		<div class="col-md-3">
			...
			<c:if test="${not empty userobj }">
				<a class="btn btn-success text-white"><i
					class="fas fa-user mr-1"></i>${userobj.name}</a>
				<a data-toggle="modal" data-target="#exampleModalCenter"
					class="btn btn-primary"><i class="fas fa-sign-in-alt mr-1"></i>Logout</a>
			</c:if>
			<c:if test="${empty userobj }">
				<a href="../login.jsp" class="btn btn-success"><i
					class="fa-solid fa-plus mr-1"></i>Login</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="home.jsp"><i
					class="fas fa-house mr-2"></i>Home</a></li>
		</ul>
	</div>
</nav>